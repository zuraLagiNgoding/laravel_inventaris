    ...
    <div class="py-12 relative h-full overflow-hidden">   
        ...
        <div class="flex flex-col gap-4 max-w-7xl mx-auto h-full sm:px-6 lg:px-8">
            <div class="flex justify-between">
                <form action="{{ route('pembelian') }}" method="get" class="flex items-center max-w-sm bg-white px-4 py-2 border h-10 overflow-hidden rounded-3xl">
                ...
                <a href="{{ route("pembelian.save") }}" class="bg-gray-900 gap-2 text-white font-medium px-4 py-1 rounded-md flex items-center text-sm">New Pembelian <x-feathericon-plus-circle class="w-5 h-5 fill-white text-gray-900"/></a>
            </div>
