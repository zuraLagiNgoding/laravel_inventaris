        ...
        <div class="flex flex-col gap-4 max-w-7xl mx-auto h-full sm:px-6 lg:px-8">
            <div class="flex justify-end">                
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ url()->current() . '/save' }}" class="bg-gray-900 gap-2 text-white font-medium h-full px-4 py-2 rounded-lg flex items-center text-sm">New Ruangan <x-feathericon-plus-circle class="w-5 h-5 fill-white text-[#2D232E]"/></a>
                </div>
            </div>
