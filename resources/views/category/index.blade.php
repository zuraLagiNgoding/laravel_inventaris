        ...
        <div class="flex flex-col gap-4 max-w-7xl mx-auto h-full sm:px-6 lg:px-8">
            <div class="flex justify-end">                
                <div class="flex items-center gap-3">
                    <a href="{{ route("category.export") }}" class="border border-green-600 gap-2 hover:bg-green-200/10 text-green-600 font-medium h-full px-4 py-2 rounded-lg flex items-center text-sm">Generate Report<x-bx-spreadsheet class="w-5 h-5 "/></a>
                    <a href="{{ route("category.save") }}" class="bg-gray-900 gap-2 text-white font-medium h-full px-4 py-2 rounded-lg flex items-center text-sm">New Category Barang <x-feathericon-plus-circle class="w-5 h-5 fill-white text-[#2D232E]"/></a>
                </div>
            </div>
